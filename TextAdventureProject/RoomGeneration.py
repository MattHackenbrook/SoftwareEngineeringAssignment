...
Zombie = {"Stats": {"Strength": 1, "Thrift": 0, "Persuasion": 0, "Armour": 1, "Health": 1}, "Inventory": {},
          ...
          "Desc": "A Zombie, missing a jaw looks around with only one eye that stares hungrily",
          "Class": "zombie"}
...
HardGarbage = {"Class": "Throwable",
               "Desc": "A hard solid mass of dried up Garvage, who knows what this used to be,"
...
Cafeteria = {"Doors": {"Kitchen Door": KitchenDoor, "South Hall Door": SouthHallDoor, "West Hall Door": WestHallDoorCaf,
             ...
             "Containers": {"Ground": {}, "Trash Can": TrashCan, "Pile of leftovers": PileofLeftovers,
             ...
             "LongDesc": "You walk into a big open room with rectangular dinning tables strewn about. Old plates of "
                         "food and broken chairs are thrown around, a smell of mold permeates the air, im glad im not"
                         " hungry right now",
             "Visited": False}
...
FrontGateDoor = {"Locked": True,
                 "Desc": "Through the metal Iron bars, it looks like there's another gate across "
                         "this control room that leads to the road, freedom."}

GuardRoomDoorExt = {"Locked": True,
                    "Desc": "there are some computer screens that are still lit and something"
                            " that looks like a metal cylinder."}
...
Basketball = {"Class": "Throwable", "Desc": "A roughed up faded orange basketball",
              "Traits": {"Damage": 1, "Throw": 1}}

Horde = {"Stats": {"Strength": "50", "Thrift": "0", "Persuasion": "0", "Armour": "50", "Health": "50"}, "Inventory": {},
         "Wearing": {},
         "Desc": "A Huge horde of almost 50 zombies wanders around aimlesly together as they look for"
                 " any way to move around.",
         "class": "Horde"}

Courtyard = {
    "Doors": {
        "Front Gate Door": FrontGateDoor,
        "Guard Room Door": GuardRoomDoorExt,
        "Cafeteria Door": CafeteriaDoor,
        "South Hall Door": SouthHallDoor,
        "Tool Shed Door": ToolShedDoor
    },
    "Containers": {
        "Ground": Basketball
    },
    ...
    "ShortDesc": "The dried grass sways in the wind and the concrete walls stand firm",
    "LongDesc": "A cobblestone path leads out to the front gate. Dried grass makes up the field ahead as the concrete"
                " walls surrounding you a recovered by moss with barbed wire wrapped around the top, an orange sphere "
...
Shank = {"Class": "melee", "Desc": "A small plastic toothbrush with a sharp filled end", "Traits": {"Damage": 3}}

NorthHall = {
    "Doors": {
        "North Cell Block Door": NorthCellBlockDoor,
        "Guard Room Door": GuardRoomDoorInt,
        "Hospital Door": HospitalDoorN,
        "West Hall Door": WestHallDoorN
    },
    "Containers": {
        "Ground": Shank
    },
...
BloodyCell = {"Doors": {"South Cell Block Door": SouthCellBlockDoor}, "Containers": {"Ground": Limb}, "Characters": {},
              ...
              "LongDesc": "A grotestesque scene of blood and gore, it looks as though the inmate who belonged "
                          "in this cell is now the bloody puddle of red slop in the floor. the cell is turned "
                          "upsidedown, there must have been a terrible struggle before he was pinned down on the"
                          " floor and eaten alive. note to self, dont get cornered.",
              "Visited": False}
...
Corpse = {"Items": {"key": Key},
          "Desc": "the mutilated corpse of one of the inmates, Pedro, face first in the ground, his back completly"
                  " devoured.  his right arm is outstretched looks like he was holding something. Bugger always had"
                  " sticky fingers"}
...
WestCellBlock = {"Doors": {"My Cell Door": StartDoor, "West Hall Door": WestHallDoor},
                 ...
                 "LongDesc": "The familiar cell block no longer looks the same.  the once clean interior is now"
                             " spattered with blood, littered with broken furniture, busted cell doors and metal "
                             "bars, near the exit door you see the body of an inmate, he looks like someone you know.",
                 "Visited": False}
...
HalfZombie = {"Stats": {"Strength": 1, "Thrift": -1, "Persuasion": 0, "Armour": 0, "Health": 1}, "Inventory": {},
              "Wearing": {},
              "Desc": "A zombie missing the lower half of its body tried to painfully crawl its way"
                      " towards you using one of its decaying arms",
              "Class": "legless"}

WasteDump = {"Doors": {"Waste dump door": WasteDumpDoor}, "Containers": {"Ground": {}},
             ...
             "LongDesc": "As you travel down this tunnel of refuse you slide out into the open air and land into an"
                         " even bigger pile of waste as you are dumped out of the prison's sewage, as you are inches"
                         " away from freedom.  theres seems to be something moving in the waste with you.",
             "Visited": False}
...
CourtyardDoor = {
    "Locked": True,
    "Desc": "This is the door to the Courtyard"
}

Shovel = {
    "Class": "Key",
    "Desc": "You pick up a shovel, You can use it to break through somewhere",
    "Traits": {"Damage": 3}}
...
Box = {
    ...
    "Desc": "You see a box with something inside"
}
...
ToolShed = {
    ...
    "LongDesc": "As you enter the tool shed you see a locker full of shovels. You remember the countless "
                "days you spent digging holes for the prison under the hot sun. The guards would laugh as "
                "they poured your water in the hole infront of you, leaving you with a burning sensation in "
                "your throat with no way to quench your thirst. 'Im glad those bastards are dead' you say"
                " to yourself.",
    "Visited": False
}
...
WestHallDoor = {
    "Locked": True,
    "Desc": "This leads to the West Hall"
}
...
CafeteriaDoor = {
    "Locked": False,
    "Desc": "This leads to the Cafeteria."
}
...
SouthHall = {
    "Doors": {
        ...
        "Washroom Door": WashroomDoor,
        "South Cell Block Door": SouthCellBlockDoor,
        "Janitor's Closet Door": JanitorClosetDoor,
        "Cafeteria Door": CafeteriaDoor
    },
    "Containers": {
        "Ground": {}
    ...
    "ShortDesc": "The South Hall",
    "LongDesc": "The South Hall looks completely abandoned just like West Hall did. You see several corpses with "
                "missing limbs and what looks like bites that have been taken out of them. As you take a closer "
                "look you see a corpse with its eyes wide open and quickly realize it was your good friend Jeff. "
                "You take a moment to close his eyes and pray that he is in a better place now. A tear runs down "
                "your face as you get up and continue to move on trying to escape this hellhole.",
    "Visited": False
}
...
NurseZombie = {
    ...
    "Inventory": {},
    "Wearing": {},
    "Desc": "A zombie wearing a nurse uniform",
    "Class": "zombie"
}
...
Tray = {"Items": {"Surgical Knife": SurgicalKnife}, "Desc": "You see a surgical knife laid out on the tray"}
...
SouthHallDoor = {
    "Locked": False,
    "Desc": "This leads to the South Hall"
}

SewerDoor = {
    "Locked": True,
    "Desc": "You see a crack in the floor that looks like it might lead somewhere. You need a something strong like a"
            " sledgehammer to break through."
}

Pipe = {
    "Class": "Melee",
    "Desc": "This pipe must have fallen from the ceiling after the pipes burst",
    "Traits": {
        "Damage": 2
    }
}
...
Washroom = {
    ...
    "Characters": {},
    "ShortDesc": "The Washroom",
    "LongDesc": "You can hear the slow fall of water dripping from the ceiling, you take a step forward and feel"
                " something wet at your feet. You look down to see you are standing in a pool of blood. The washroom"
                " has been the place of many unspeakable acts, but thankfully you have never dropped the soap and are "
                "safe from the traumatizing experience other inmates faced. As you examine the room you notice a giant"
                " crack in the floor and see a small pipe next to it.",
    "Visited": False}
...
NorthCellBlockDoor = {
    "Locked": False,
    "Desc": "This leads to the North Cell Block"
}

Sledgehammer = {
    "Class": "melee",
    "Desc": "A giant sledgehammer, good for smashing.",
    "Traits": {
        "Damage": 7
    }
}
...
IvanCell = {
    ...
    "LongDesc": "This cell belongs to Ivan. The beast of the prison. You heard stories about how he killed 10 men"
                " with only his fists. You do not want to run into this guy",
    "Visited": False
}
...
HalfUsedCrackPipe = {
    ...
    "Traits": {"Damage": 2, "Healing": 1}}

BandAids = {
    "Class": "Misc",
    "Desc": "Band-aids may come in handy if i run into zombies or worse",
    "Traits": {
        "Healing": 3
    }
}
...
SouthHallDoor = {
    "Locked": False,
    "Desc": "Looks like a hallway but heading in the south direction"
}

JoesDrawer = {
    "Items": {
        "Half Used Crack Pipe": HalfUsedCrackPipe,
        "Band Aids": BandAids
    },
...
JanitorsCloset = {
    ...
    "LongDesc": "The Janitor’s Closet is a small room in the south hall. Joe Dirt's the prison Janitor, he doens't"
                " carry a weapon but he's always high, his stash might be inside the closet. As you approach you don't"
...
WestCellBlockDoor = {
    "Locked": True,
    "Desc": "Dirty floor and walls , zombie free for now"
}
...
HospitalDoorW = {
    "Locked": True,
    "Desc": "A series of what looks like unmade beds with dirty white sheets"
}
...
Syringe = {
    "Class": "melee",
    "Desc": "A used syringe, can be used to poison",
    "Traits": {
        "Damage": 5
    }
}
...
WestHall = {
    "Doors": {
        "West Cell Block Door": WestCellBlockDoor,
        "Easter Egg Room Door": EasterEggRoomDoor,
...
CourtYardDoor = {
    "Locked": True,
    "Desc": "You can see into the courtyard, from what you can tell this is how you entered the prison, but now"
            " there's a bunch of zomies roaming around"
}
...
BulletProofVest = {
    "Class": "Misc",
    "Desc": "A old vest with stab marks, but it's bullet proof",
    "Traits": {
        "Damage": 1,
        "Health": 15
    }
...
characters = {
    "Zombie steve": build_character(zombie_stats, zombie_inv,
                                    {"Prison Uniform": prison_uniform}, "Steve, but a zombie.", "Zombie"),
    "Zombie jeff": build_character(zombie_stats, zombie_inv,
                                   {"Prison Uniform": prison_uniform}, "Jeff, but a zombie.", "Zombie"),
    "Zombie fred": build_character(zombie_stats, zombie_inv,
                                   {"Prison Uniform": prison_uniform}, "Fred, but a zombie.", "Zombie"),
    "Zombie jack": build_character(zombie_stats, zombie_inv,
                                   {"Prison Uniform": prison_uniform}, "Jack, but a zombie.", "Zombie")
}
